...
<body>
  ...
  <section>
    ...
    <p>Возможные причины: отсутствие подключения к&nbsp;интернету, технические неполадки, блокировка сайта в&nbsp;вашем&nbsp;регионе</p>
    <p>Актуальный домен можно получить в&nbsp;нашем Telegram&nbsp;боте: <a href="https://t.me/SigmaGamesBot">@SigmaGamesBot</a></p>
  </section>
</body>`
