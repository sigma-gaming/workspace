...
const Header = () => {
  return (
    <div className="pointer-events-none sticky top-0 z-50 h-[--header-height] py-2 bg-[#1B1C2F] bg-opacity-80 lg:bg-transparent flex items-center justify-between backdrop-blur-md shadow-border lg:shadow-none">
